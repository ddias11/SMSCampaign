...
public class SMSJobsScheduler {
	...
	public static void scheduleMailMessagesReceivedJob() throws SchedulerException {
		...
		LOGGER.info("Scheduling MailMessagesReceivedJob at "
				+ JobsScheduleProperties.getString("JobsScheduler.MAIL_NOTIFICATION_SCHEDULE"));
	...
	public static void scheduleQueryRemainCreditJob() throws SchedulerException {
		LOGGER.info("Scheduling QueryRemainCreditJob at "
				+ JobsScheduleProperties.getString("JobsScheduler.QUERY_REMAIN_CREDIT_SCHEDULE"));
	...
	public static void scheduleSystemPrevaylerModelSnapshotJob() throws SchedulerException {
		...
		LOGGER.info("Scheduling SystemPrevaylerModelSnapshotJob at "
				+ JobsScheduleProperties.getString("JobsScheduler.SNAPSHOT_SCHEDULE"));
